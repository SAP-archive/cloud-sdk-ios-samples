...
class CategoryMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    var demoService: DemoService<OfflineODataProvider>!
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([Category]?, Error?) -> Void) -> Void)?
    private var entities: [Category] = [Category]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "ID", value: "\(category.id!)")
        return cell
    }
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        self.demoService.deleteEntity(currentEntity) { error in
            if let error = error {
...
extension CategoryMasterViewController: EntitySetUpdaterDelegate {
