...
class CategoryDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "CategoryMasterViewControllerLogger")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "updateEntity" {
            ...
            let detailViewController = dest.viewControllers[0] as! CategoryDetailViewController
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            return self.cellForId(tableView: tableView, indexPath: indexPath, currentEntity: self.entity, property: Category.id)
        case 1:
            return self.cellForName(tableView: tableView, indexPath: indexPath, currentEntity: self.entity, property: Category.name)
        case 2:
        ...
        case 2:
            if !self.entity.isNew {
                ...
                func loadProperty(_ completionHandler: @escaping ([Product]?, Error?) -> Void) {
                    self.demoService.loadProperty(Category.products, into: self.entity) { error in
    ...
    private func cellForId(tableView: UITableView, indexPath: IndexPath, currentEntity: Category, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForName(tableView: UITableView, indexPath: IndexPath, currentEntity: Category, property: Property) -> UITableViewCell {
        var value = ""
        ...
        return CellCreationHelper.cellForProperty(tableView: tableView, indexPath: indexPath, entity: self.entity, property: property, value: value, editingIsAllowed: self.allowsEditableCells, changeHandler: { (newValue: String) -> Bool in
            ...
            if newValue.isEmpty {
                ...
                if Category.name.isOptional || newValue != "" {
...
extension CategoryDetailViewController: EntityUpdaterDelegate {
    func entityHasChanged(_ entityValue: EntityValue?) {
        if let entity = entityValue {
            let currentEntity = entity as! Category
