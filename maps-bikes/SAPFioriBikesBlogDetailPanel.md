...
This project follows up with the original [SAPFioriBikes Blog](SAPFioriBikesBlog.md) by configuring the Search Results View Controller and Content View Controller.

![Detail Panel Search Results Bart](ReadMeImages/PanelWalkThrough.gif)

> Extending the SAPFioriBikes project with the MapFloorplan DetailPanel. Check out the implementation of the code at the `SAPFiori Bikes - Post 2` commit.
