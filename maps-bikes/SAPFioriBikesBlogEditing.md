...
> Extending the SAPFioriBikes project by adding custom points, polylines, and polygons. Check out the implementation of the code at the `SAPFiori Bikes - Post 4` commit.
